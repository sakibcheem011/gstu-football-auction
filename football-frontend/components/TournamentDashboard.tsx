...
export function TournamentDashboard() {
  ...
  useEffect(() => {
    fetch(`${process.env.NEXT_PUBLIC_API_URL }/tournament/standings`).then(r => r.json()).then(setStandings).catch(console.error);
    fetch(`${process.env.NEXT_PUBLIC_API_URL }/tournament/fixtures`).then(r => r.json()).then(setFixtures).catch(console.error);
    fetch(`${process.env.NEXT_PUBLIC_API_URL }/teams`).then(r => r.json()).then(setTeams).catch(console.error);
  }, []);
