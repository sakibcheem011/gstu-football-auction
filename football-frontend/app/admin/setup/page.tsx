...
export default function SuperAdminSetup() {
  ...
  const fetchData = async (t: string) => {
    try {
      const [resConfig, resTeams, resPlayers, resStaff, resCat, resTier, resSess, resPending] = await Promise.all([
        fetch(`/rules/config`),
        fetch(`/teams`),
        fetch(`/players`, { headers: { Authorization: `Bearer ${t}` } }),
        fetch(`/auth/staff`, { headers: { Authorization: `Bearer ${t}` } }),
        fetch(`/rules/categories`),
        fetch(`/rules/tiers`),
        fetch(`/rules/sessions`),
        fetch(`/teams/pending-managers`, { headers: { Authorization: `Bearer ${t}` } })
      ]);
  ...
  const updatePhase = async (phase: string) => {
    const res = await fetch(`/rules/phase`, {
      method: 'PUT',
  ...
  const updateAuctionMode = async (mode: string) => {
    const res = await fetch(`/rules/mode`, {
      method: 'PUT',
      headers: { 'Content-Type': 'application/json', Authorization: `Bearer ${token}` },
  ...
  const updateDraftOrder = async (order: any[]) => {
    const res = await fetch(`/rules/draft-order`, {
      method: 'PUT',
      headers: { 'Content-Type': 'application/json', Authorization: `Bearer ${token}` },
  ...
  const updateTimerConfig = async (e: React.FormEvent) => {
    e.preventDefault();
    const res = await fetch(`/rules/timer`, {
      method: 'PUT',
      headers: { 'Content-Type': 'application/json', Authorization: `Bearer ${token}` },
  ...
  const updateBudgetConfig = async (e: React.FormEvent) => {
    e.preventDefault();
    const res = await fetch(`/rules/budget`, {
      method: 'PUT',
      headers: { 'Content-Type': 'application/json', Authorization: `Bearer ${token}` },
  ...
  const createCategory = async (e: React.FormEvent) => {
    e.preventDefault();
    const res = await fetch(`/rules/categories`, {
  ...
  const deleteCategory = async (id: string) => {
    await fetch(`${process.env.NEXT_PUBLIC_API_URL || ``}/rules/categories/${id}`, { method: 'DELETE', headers: { Authorization: `Bearer ${token}` } });
    fetchData(token!);
  };

  const createTier = async (e: React.FormEvent) => {
    e.preventDefault();
    const res = await fetch(`/rules/tiers`, {
      method: 'POST', headers: { 'Content-Type': 'application/json', Authorization: `Bearer ${token}` },
  ...
  const deleteTier = async (id: string) => {
    await fetch(`${process.env.NEXT_PUBLIC_API_URL || ``}/rules/tiers/${id}`, { method: 'DELETE', headers: { Authorization: `Bearer ${token}` } });
    fetchData(token!);
  };

  const createSession = async (e: React.FormEvent) => {
    e.preventDefault();
    const res = await fetch(`/rules/sessions`, {
      method: 'POST', headers: { 'Content-Type': 'application/json', Authorization: `Bearer ${token}` },
  ...
  const deleteSession = async (id: string) => {
    await fetch(`${process.env.NEXT_PUBLIC_API_URL || ``}/rules/sessions/${id}`, { method: 'DELETE', headers: { Authorization: `Bearer ${token}` } });
    fetchData(token!);
  };
  ...
  const executeApproveManager = async (e: React.FormEvent) => {
    ...
    const res = await fetch(`/teams/approve-manager`, {
      method: 'POST',
      headers: { 'Content-Type': 'application/json', Authorization: `Bearer ${token}` },
      body: JSON.stringify({ 
  ...
  const executeRejectManager = async (managerId: string) => {
    setConfirmDialog({
      ...
      onConfirm: async () => {
        ...
        const res = await fetch(`/teams/reject-manager/${managerId}`, {
          method: 'DELETE',
  ...
  const updateManager = async (e: React.FormEvent) => {
    ...
    const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL || ``}/teams/${editingTeam.id}/manager`, {
      method: 'PUT',
      headers: { 'Content-Type': 'application/json', Authorization: `Bearer ${token}` },
      body: JSON.stringify({ 
  ...
  const uploadLogo = async (e: React.FormEvent) => {
    ...
    const res = await fetch(`/teams/${logoDialog.team.id}/logo`, {
      method: 'POST',
      headers: { Authorization: `Bearer ${token}` },
      body: formData
    });
  ...
  const createStaffAccount = async (e: React.FormEvent) => {
    e.preventDefault();
    const res = await fetch(`/auth/staff`, {
      method: 'POST',
      headers: { 'Content-Type': 'application/json', Authorization: `Bearer ${token}` },
  ...
  const deleteStaff = async (id: string) => {
    setConfirmDialog({
      ...
      onConfirm: async () => {
        setConfirmDialog(null);
        const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL || ``}/auth/staff/${id}`, {
          method: 'DELETE',
          headers: { Authorization: `Bearer ${token}` }
        });
        if (res.ok) {
  ...
  const updatePlayerDetails = async (e: React.FormEvent) => {
    ...
    const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL || ``}/players/${selectedPlayer.id}`, {
      method: 'PUT',
      headers: { 'Content-Type': 'application/json', Authorization: `Bearer ${token}` },
      body: JSON.stringify({
        name: editPlayerName,
  ...
  const executeSystemReset = async (level: number) => {
    setConfirmDialog({
      ...
      onConfirm: async () => {
        setConfirmDialog(null);
        const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL || ``}/system/reset/level${level}`, {
          method: 'POST',
          headers: { Authorization: `Bearer ${token}` }
        });
